...
import numpy as np
from sim import add_delay, add_cfo
from basic_chain import BasicChain
...
y, delay = add_delay(chain,x,0) # application of ideal channel (if TX and RX oversampling factors are different)
